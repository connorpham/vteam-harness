...
argument-hint: "[--update: revise an existing brief/PRD after answers changed]"
---
...
3. **Outputs are SOURCE documents, and they live OUTSIDE `docs/specs/`.**
...
5. **Close the learning loop** — a lesson (+1 INDEX line) into
   `docs/qa/knowledge-base.md`, or "no new lesson".
...
- [ ] P3 ran or its skip is declared with a reason; ADR candidates listed, no
      ADR written
- [ ] Planning docs live OUTSIDE `docs/specs/` (the shard dir belongs to the
