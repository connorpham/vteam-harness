...
| 2026-08-28 | DEV | Connor Pham | VT-3 competencies — DEV craft layer (10 files) + competency_check gate + /dev routing | done (frontier) · tok ≈ 350k | branch feat/VT-3-competencies |
